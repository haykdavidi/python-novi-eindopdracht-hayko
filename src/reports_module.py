...
# Klasse die een bezoekrapport vertegenwoordigt.
class Visit:
    def __init__(
            self,
            inspector_code,
        ...
        #  Initialiseert een bezoekrapport met de gegeven parameters.
    ...
    # Geeft de inspecteurscode van het bezoekrapport terug.
    def get_inspector_code(self):
        return self.__inspector_code

    # Geeft de bedrijfscode van het bezoekrapport terug.
    def get_company_code(self):
        return self.__company_code

    # Geeft de bezoekdatum van het bezoekrapport terug
...
# Toont een overzicht van alle bezoekrapporten van een bedrijf
...
# Toont een overzicht van alle bezoekrapporten van een inspecteur.
