...
def get_list_of_most_polluted_locations(array_to_check, number_of_locations):
    """Returns a list of tuples with the locations of the highest measured values and the values themselves"""
