...
# Functie om alle bestanden van de applicatie te uploaden.
def upload_files():
    file_reader.read_all_files()


#  Functie om bedrijfsrapporten weer te geven.
